...
import Image2 from "../../assets/coffee2.png";
import Image3 from "../../assets/steak.png";
  ...
  return (
    <div className="container py-10">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-semibold  mb-4">Menu List</h1>
        <Link to="/menu" className="primary-btn hover:scale-105 duration-200">
          Visit Our Menu
        </Link>
      </div>
      {/* card section */}
      <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 gap-8">
        {FoodData.slice(0, 3).map((item, index)=> (
          <div
            key={index}
