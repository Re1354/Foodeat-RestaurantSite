...
const chefs = [
  {
    ...
    image: chef1,
    description:
      'Bonnie is a culinary expert with a passion for creating innovative dishes that delight the senses.',
  },
  {
    name: 'James Lee',
    ...
    image: chef2,
    description:
      'James crafts exquisite desserts that turn every meal into a celebration.',
  },
  {
    name: 'Sophia Kim',
    role: 'Head Sous Chef',
    image: chef3,
    description:
      'Sophia ensures flawless execution in the kitchen with creativity and precision.',
  },
  {
    name: 'Sophia Kim',
    role: 'Head Sous Chef',
    ...
    <div className="container py-14">
      ...
      <div className="text-center mb-12">
        ...
        <p className="mt-2 text-gray-900 text-lg max-w-xl mx-auto">
          A glimpse into our restaurant’s special events and proud achievements
          — moments that reflect our passion, excellence, and unforgettable
          experiences.
        </p>
      </div>
      ...
      {/* Chef Section */}
      <div className="mt-16">
        <h1 className="text-4xl font-semibold text-left text-gray-800/990 mb-10 underline-offset-2 pl-4">
          Meet Our{' '}
          <span className="text-black font-extrabold">Key Employees</span>{' '}
          —{' '}
        </h1>
...
"
            >
              <img
                ...
                alt={chef.name}
              />
              <h5 className="text-xl text-orange-500 font-semibold dark:text-gray-900 mb-1 transition-colors duration-300">
                {chef.name}
              </h5>
              <span className="font-semibold dark:text-orange-500 text-gray-950 mb-2">
                {chef.role}
              </span>
              <p className="text-sm font-thin text-gray-[850] text-center dark:text-gray-950 px-6">
                {chef.description}
              </p>
            </div>
          ))}
